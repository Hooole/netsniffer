...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  proxy: {
    ...
    setSystemProxy: (config: any) => ipcRenderer.invoke('proxy:setSystemProxy'),
  ...
  // 系统相关API
  system: {
    openExternal: (url: string) => ipcRenderer.invoke('system:openExternal'),
    showItemInFolder: (path: string) => ipcRenderer.invoke('system:showItemInFolder'),
