...
export const RequestDetailDialog: React.FC<RequestDetailDialogProps> = ({
  ...
  const items = [
    ...
    },
    {
      key: 'requestHeaders',
      label: '请求头',
      children: request?.requestHeaders && Object.keys(request.requestHeaders).length > 0 ? (
        <Table
    ...
    },
    {
      key: 'responseHeaders',
      label: '响应头',
      children: request?.responseHeaders && Object.keys(request.responseHeaders).length > 0 ? (
        <Table
        ...
        <div>
          <div style={{ marginBottom: 10 }}>
            <Space>
              ...
              <Text type="secondary">
                类型: {request.requestHeaders?.['content-type'] || '-'}
              </Text>
            </Space>
          </div>
          <Paragraph
        ...
        <div>
          <div style={{ marginBottom: 10 }}>
            <Space>
              ...
              <Text type="secondary">
                类型: {request.responseHeaders?.['content-type'] || '-'}
              </Text>
            </Space>
          </div>
          <Paragraph
